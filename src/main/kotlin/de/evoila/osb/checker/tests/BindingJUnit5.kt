...
class BindingJUnit5 : TestBase() {
    ...
    fun runValidBindings(): List<DynamicNode> {
        //TODO check for other catalogRequestRunner methods
        ...
        catalog.services.forEach { service ->
            service.plans.forEach { plan ->
                ...
                //TODO parse is retrievable param from v2/catalog request
//                println(" is retriavable  ::"+service.bindingsRetrievable)
                if (bindable) {
                    testContainers.add(validBindingContainer(binding, instanceId, bindingId, true))
                }
